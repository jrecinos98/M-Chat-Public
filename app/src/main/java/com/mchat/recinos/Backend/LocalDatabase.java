...
import com.mchat.recinos.Backend.DAOs.LatestDao;
...
@Database(entities = {Chat.class, Latest.class, Message.class}, version = 1, exportSchema = false)
public abstract class LocalDatabase extends RoomDatabase {
    //One per table in database
    public abstract ChatDao chatDao();
    public abstract MessageDao messageDao();
    public abstract LatestDao latestMessageDao();
    ...
    //Used whenever a write request is to be made to the database. Need to call execute on it and pass a lambda func (runnable)
    public static final ExecutorService IOWriteExectutor = Executors.newFixedThreadPool(NUMBER_OF_IO_THREADS);
