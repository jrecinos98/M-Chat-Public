        ...
        if(contextRef.get() != null) {
            ...
            if(m.getType() == Constants.MESSAGE_DATA_TYPES.TEXT) {
                ...
                if(message.getImage() == null){
                    ...
                    BitmapTransform.SerialBitmap serialBitmap =  LocalStorage.readInternalFile(contextRef.get(),IO.formatSubDirectory(Constants.INTERNAL_DIRECTORY.MESSAGE_IMAGES, String.valueOf(message.getOwner_cid())),   message.getFileName());
