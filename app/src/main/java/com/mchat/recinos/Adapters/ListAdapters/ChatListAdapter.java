...
import com.mchat.recinos.Activities.ChatActivity;
...
public class ChatListAdapter extends RecyclerView.Adapter<ChatListAdapter.ViewHolder> {
    ...
    public ChatListAdapter(Context context, ChatViewModel viewModel){
            ...
            if(mContext != null) {
                if(!chats.isEmpty()) {
                    ...
                    if(chat.getUnreadCount() > 0){
                        chatViewModel.updateChatPreview(chat.getUID(), chat.getPreview(), Util.getTime(), 0);
                        chat.resetUnread();
