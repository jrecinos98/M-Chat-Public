...
public abstract class Constants {
    ...
    public final static class MIME_TYPES{
        //MediaStore.MediaColumns requires this path. It can be combine with extension types to form specific ones.
        //Ex: images/jpg, images/png, etc..
    ...
    public final static class PERMISSION{
        //These are the same since they are in the same permission group
